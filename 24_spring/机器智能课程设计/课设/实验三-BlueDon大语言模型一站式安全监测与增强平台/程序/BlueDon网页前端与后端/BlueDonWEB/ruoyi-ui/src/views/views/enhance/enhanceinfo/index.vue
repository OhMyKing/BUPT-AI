<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['enhance:enhanceinfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['enhance:enhanceinfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['enhance:enhanceinfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['enhance:enhanceinfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="enhanceinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="enhancementApiId" />
...
<script>
import { listEnhanceinfo, getEnhanceinfo, delEnhanceinfo, addEnhanceinfo, updateEnhanceinfo } from "@/api/enhance/enhanceinfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除增强任务管理编号为"' + enhancementApiIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('enhance/enhanceinfo/export', {
        ...this.queryParams
