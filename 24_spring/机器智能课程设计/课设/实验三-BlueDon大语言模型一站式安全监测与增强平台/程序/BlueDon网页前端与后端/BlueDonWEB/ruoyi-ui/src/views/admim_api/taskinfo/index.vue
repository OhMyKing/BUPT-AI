<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['admim_api:taskinfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['admim_api:taskinfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['admim_api:taskinfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['admim_api:taskinfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="taskinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务序号" align="center" prop="taskId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="任务报告" prop="taskReportPdf">
          <file-upload v-model="form.taskReportPdf"/>
        </el-form-item>
      </el-form>
...
<script>
import { listTaskinfo, getTaskinfo, delTaskinfo, addTaskinfo, updateTaskinfo } from "@/api/admim_api/taskinfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除测试任务管理编号为"' + taskIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('admim_api/taskinfo/export', {
        ...this.queryParams
