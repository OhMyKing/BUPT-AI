...
def autodan_hga_eval(args = default_args):
    ...
    for i, (g, t, label) in tqdm(enumerate(dataset), total=len(harmful_data.goal[args.start:end])):
        ...
        path = f'./results/attack/attack_log/hga/{args.model}_{args.start}_to_{end-1}_{args.save_suffix}.json'
