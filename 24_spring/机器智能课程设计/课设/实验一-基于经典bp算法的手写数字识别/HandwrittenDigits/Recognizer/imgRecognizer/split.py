...
class SplitPhoto:
    ...
    def FloodNoise(self, temImg):
        ...
        color_count=np.full([256],0,np.int32)
    ...
    def getcontours(self, temImg):
        cv2.imwrite('pictures/2314.jpg', temImg)
        temImg = cv2.imread('pictures/2314.jpg')
    ...
    def opencvdeal(self,path):
        ...
        cv2.imwrite('pictures/2314.jpg', dealimg)
        img = cv2.imread('pictures/2314.jpg')
